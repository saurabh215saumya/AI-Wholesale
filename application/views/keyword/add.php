        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="location" class="form-control" value="<?php echo set_value('location'); ?>" placeholder="e.g. Hounslow">
            </div>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="page_slug" class="form-control" value="<?php echo set_value('page_slug'); ?>" placeholder="e.g. wholesale-cash-and-carry-hounslow">
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label>Page Title</label>
              <input type="text" name="page_title" class="form-control" value="<?php echo set_value('page_title'); ?>">
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label>Page URL</label>
              <input type="text" name="page_url" class="form-control" value="<?php echo set_value('page_url'); ?>">
            </div>
          </div>
        </div>
