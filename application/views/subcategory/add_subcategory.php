<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb"><li><a href="<?php echo base_url('admin'); ?>">Home</a></li><li><a href="<?php echo base_url('subcategory'); ?>">Sub Categories</a></li><li class="active">Add</li></ol>
  </section>
  <section class="content">
    <?php echo $this->session->flashdata('response'); ?>
    <div class="box box-primary">
      <div class="box-header"><h3 class="box-title">Add New Sub Category</h3></div>
      <?php echo form_open('subcategory/add_newsubcategory'); ?>
      <div class="box-body">
        ...
        <div class="form-group <?php echo form_error('sub_category_name') ? 'has-error' : ''; ?>">
          ...
          <input type="text" name="sub_category_name" class="form-control" value="<?php echo set_value('sub_category_name'); ?>">
