    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div>
            <label class="radio-inline"><input type="radio" name="variant_type" value="per_quantity" checked> Per Quantity <small class="text-muted">(auto price tier by quantity entered)</small></label>
            &nbsp;&nbsp;
            <label class="radio-inline"><input type="radio" name="variant_type" value="per_carton"> Per Carton <small class="text-muted">(customer selects carton size)</small></label>
          </div>
        </div>
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-tags"></i> Price Variants <small class="text-muted" id="variant-hint-add"></small></h3>
          </div>
          <div class="box-body">
...
$(document).ready(function(){
  $('#grand_sub_category_id').closest('.form-group').hide();
  updateVariantHint();
});
$('input[name="variant_type"]').on('change', updateVariantHint);
function updateVariantHint() {
  var t = $('input[name="variant_type"]:checked').val();
  $('#variant-hint-add').text(t === 'per_quantity' ? '- Label = min qty threshold, e.g. "1", "15", "30"' : '- Label = pieces per carton, e.g. "10", "15", "30"');
}
